// Trooth Social Independent — Feed interactions enhancement v5
(function () {
  ...
  function polish(){
    if(document.getElementById('trooth-feed-v5-style')) return;
    const st=document.createElement('style');st.id='trooth-feed-v5-style';st.textContent=`
