...
(function(){
  function boot(){
    ...
    w.innerHTML='<button class="trooth-unified-btn" type="button" aria-expanded="false" aria-controls="trooth-unified-panel">🌿 My Trooth</button><div class="trooth-unified-panel" id="trooth-unified-panel" role="menu"><a role="menuitem" href="index.html">🏠 Home Feed</a><a role="menuitem" href="auth.html">👤 My Profile</a><a role="menuitem" href="friends.html">👥 Friends & Following</a><a role="menuitem" href="chat.html">💬 Messages</a><a role="menuitem" href="notifications.html">🔔 Notifications</a><a role="menuitem" href="saved.html">🔖 Saved Posts</a><a role="menuitem" href="activity.html">📊 My Activity</a><div class="sep"></div><a role="menuitem" href="settings.html">⚙️ Settings</a></div>';
    ...
    function toggle(){var open=p.classList.toggle('open');b.setAttribute('aria-expanded',open?'true':'false');}
    b.onclick=toggle;
    document.addEventListener('click',function(e){if(!w.contains(e.target))close();});
    document.addEventListener('keydown',function(e){if(e.key==='Escape')close();});
    w.addEventListener('click',function(e){if(e.target.closest('a'))close();});
  }
