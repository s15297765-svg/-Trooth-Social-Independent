// Trooth Social Independent — live home banner v3
(()=>{
  if(window.__troothHomeLiveBannerV3)return;window.__troothHomeLiveBannerV3=true;
  let timer=null;
  const show=msg=>{
  ...
  const boot=()=>{
    if(window.__troothHomeLiveBannerBootedV3)return;window.__troothHomeLiveBannerBootedV3=true;
