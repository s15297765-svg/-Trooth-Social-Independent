// Trooth Social Independent — Profile/Friends action bridge v1
(function(){
  if(window.__troothProfileFriendsActionsV1)return;window.__troothProfileFriendsActionsV1=true;
  ...
  function boot(){
    document.addEventListener('click',function(e){
      ...
      if(action==='message'){toast('💬 میسج کھولا جا رہا ہے');return}
      ...
      if(action==='add-friend'){b.disabled=true;b.classList.add('is-requested');b.textContent='Request Sent';toast('🤝 Friend request بھیج دی گئی');window.dispatchEvent(new CustomEvent('trooth-friend-request-sent',{detail:{targetId:b.dataset.userId||b.dataset.profileId||null}}));}
    });
  }
