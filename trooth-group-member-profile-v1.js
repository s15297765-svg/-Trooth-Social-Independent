  ...
  function boot(){
    ...
    function enhance(){
      document.querySelectorAll('.member').forEach(function(member){
        ...
        var remove=member.querySelector('.mini');var id='';
        ...
        btn.onclick=function(e){e.stopPropagation();location.href='profile.html?id='+encodeURIComponent(id)};member.appendChild(btn);
      });
    }
