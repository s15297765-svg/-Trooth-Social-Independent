// Trooth Social Independent — resilient install prompt + app lifecycle v3
(function(){
  ...
  function recover(){net();if(!standalone())addButton();window.dispatchEvent(new CustomEvent('trooth-pwa-lifecycle-refresh'))}
  ...
  window.addEventListener('focus',function(){if(!standalone())addButton()});
