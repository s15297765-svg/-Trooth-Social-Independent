...
(function(){
  function boot(){
    ...
    function mount(){
      ...
      b.onclick=function(){pending=false;b.classList.remove('show');if(typeof window.loadPosts==='function')window.loadPosts();window.dispatchEvent(new CustomEvent('trooth-home-feed-manual-refresh'));};
    ...
    function announce(){
      ...
      clearTimeout(timer);timer=setTimeout(function(){if(pending)b.classList.remove('show')},30000);
    }
