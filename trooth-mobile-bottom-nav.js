...
(function(){
  function boot(){
    ...
    style.textContent='.trooth-mobile-nav{display:none}@media(max-width:650px){.trooth-mobile-nav{position:fixed;left:8px;right:8px;bottom:8px;z-index:9998;background:#fff;border:1px solid #d8e9de;border-radius:18px;box-shadow:0 8px 28px #245c3a2b;padding:7px;grid-template-columns:repeat(5,1fr);gap:4px}.trooth-mobile-nav a{position:relative;color:#2d6a4f;text-decoration:none;text-align:center;font-size:11px;font-weight:800;padding:7px 3px;border-radius:12px;transition:.18s}.trooth-mobile-nav a:hover,.trooth-mobile-nav a.active{background:#d8f3dc;transform:translateY(-1px)}.trooth-mobile-nav a:focus-visible{outline:2px solid #40916c;outline-offset:2px}.trooth-mobile-nav .ico{display:block;font-size:19px;line-height:20px;margin-bottom:2px}.trooth-mobile-nav .badge{position:absolute;top:2px;right:7px;min-width:16px;height:16px;padding:0 4px;border-radius:999px;background:#d90429;color:#fff;font:800 9px/16px system-ui;text-align:center;box-shadow:0 2px 7px #0003}.trooth-mobile-nav .badge.pulse{animation:troothBadgePulse .7s ease}@keyframes troothBadgePulse{50%{transform:scale(1.22)}}body{padding-bottom:78px}}';
